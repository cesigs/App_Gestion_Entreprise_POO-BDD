...
namespace PrositFin {
	...
	/// <summary>
	/// Description résumée de FormVerifPersonnel
	/// </summary>
	public ref class FormVerifPersonnel : public System::Windows::Forms::Form
	{
	public:
		FormVerifPersonnel(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Name = L"FormVerifPersonnel";
			this->Text = L"Vérification Personnel";
			this->Load += gcnew System::EventHandler(this, &FormVerifPersonnel::Form1_Load);
